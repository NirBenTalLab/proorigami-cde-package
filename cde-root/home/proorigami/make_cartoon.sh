...
# ORIG: PTGRAPH2_OPTIONS="-r35 -t dssp -k purple -l crossing:black,red,green,navy,blue -b sequential -j -e auto -f auto -o gradient -p ddomain"
...
PTGRAPH2_OPTIONS="-r35s -t dssp -l crossing:black,red,green,navy,blue -b sequential -q -f auto -o gradient -p none -v"
